...
<div className="lb-diagram-sm">

```mermaid
%%{init: {'theme':'base','themeVariables':{'fontFamily':'inherit','fontSize':'12px','primaryColor':'#ffffff','primaryBorderColor':'#2469ff','primaryTextColor':'#1a4fd6','lineColor':'#5c8bff','clusterBkg':'#f7f9ff','clusterBorder':'#d7e2ff'},'flowchart':{'nodeSpacing':16,'rankSpacing':20,'padding':6,'diagramPadding':4}}}%%
flowchart TB
  subgraph AWS[AWS]
    subgraph S3[S3]
      direction LR
